...
void loop() {
  ...
  //DigiKeyboard.delay(500); //Fast mode
  DigiKeyboard.delay(1000);
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
  DigiKeyboard.delay(4000);                               // This can be lowered but is set high to allow outlook to launch in time
  DigiKeyboard.sendKeyStroke(KEY_SPACE, MOD_ALT_LEFT);    // Works from right to left. So this equals ALT + Space
  DigiKeyboard.delay(200);
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
  //DigiKeyboard.delay(5000);
  DigiKeyboard.sendKeyStroke(KEY_SPACE, MOD_ALT_LEFT);    // ALT+Space Then enter is a fail safe incase the window is maximized
  DigiKeyboard.delay(200);
  ...
  digitalWrite(1, HIGH);
  DigiKeyboard.delay(50000);                              // 50sec delay incase I dont get it unplugged but you could remove this and have it loop
}
